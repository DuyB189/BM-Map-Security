...
export default function EditCameraModal({ editData, setEditData, handleSave }: EditCameraModalProps) {
          ...
          <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-4">
            ...
            <div className="pt-2">
              <button 
                ...
                className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3.5 rounded-2xl shadow-lg shadow-orange-100 hover:shadow-orange-200/50 transition-all flex items-center justify-center gap-2"
              >
