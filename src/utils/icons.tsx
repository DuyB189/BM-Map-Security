import { 
  MapPin, AlertTriangle, Cctv, User, Shield, Building2, 
  Store, Flame, Route as RouteIcon 
} from 'lucide-react';

export const getIcon = (name: string) => {
  const icons: any = { MapPin, AlertTriangle, Cctv, User, Shield, Building2, Store, Flame, Route: RouteIcon };
  const IconComponent = icons[name] || MapPin;
  return <IconComponent className="w-4 h-4" />;
};

export const getSvgPath = (name: string) => {
  const paths: any = {
    ...
    'Route': '<path d="m11 3 4 4-4 4"></path><path d="m15 7-4 4"></path><path d="m15 7-4-4"></path><path d="M3 19h10a4 4 0 0 0 4-4V7"></path>'
  };
  return paths[name] || paths['MapPin'];
};
